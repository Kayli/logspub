...
- godel incompletness theorem
  - theorem of mathematical logic about natural numbers
  - shows limits of provability in formal axiomatic theories
  - no consistent system of axioms with theorems is capable of proving all truths about the arithmetic of natural numbers
    - considering that theorems can be listed by an effective procedure (i.e., an algorithm)
  ...
  - such system also cannot demonstrate its own consistency
